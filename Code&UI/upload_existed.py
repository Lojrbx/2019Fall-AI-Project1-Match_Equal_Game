...
# Form implementation generated from reading ui file 'upload_existed.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.widget.setGeometry(QtCore.QRect(120, 120, 152, 52))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "您输入的等式已存在！"))
