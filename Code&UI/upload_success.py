...
# Form implementation generated from reading ui file 'upload_success.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.widget.setGeometry(QtCore.QRect(140, 90, 121, 81))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "上传成功！"))
